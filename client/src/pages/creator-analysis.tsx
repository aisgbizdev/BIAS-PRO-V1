  ...
  return (
    <div className="flex-1 bg-[#0A0A0A] text-white">
      ...
      <div className="max-w-5xl mx-auto px-4 py-4 md:py-6 space-y-4 md:space-y-6">
        ...
        <TabsList className="grid w-full grid-cols-2 sm:grid-cols-4 gap-1 bg-[#141414] border border-gray-800 p-1 rounded-xl">
            <TabsTrigger 
              value="upload"
              className="data-[state=active]:bg-gray-700/80 data-[state=active]:text-white text-gray-300 text-[11px] sm:text-xs md:text-sm px-2 py-2 rounded-lg flex items-center justify-center gap-1 min-h-9 sm:min-h-10"
            ...
            <button
              ...
              className="text-gray-300 hover:text-white text-[11px] sm:text-xs md:text-sm px-2 py-2 rounded-lg flex items-center justify-center gap-1 min-h-9 sm:min-h-10 hover:bg-gray-700/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-600/60"
