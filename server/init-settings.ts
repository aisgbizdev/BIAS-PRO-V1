...
const defaultSettings = [
  { key: 'daily_video_limit', value: '20', valueType: 'number', category: 'limits', labelEn: 'Daily Video Analysis Limit', labelId: 'Limit Analisis Video Harian', descriptionEn: 'Maximum video/screenshot analysis per day for free users', descriptionId: 'Maksimum analisis video/screenshot per hari untuk user gratis', isEditable: true },
...
const defaultPricingTiers = [
  { slug: 'gratis', name: 'Gratis', priceIdr: 0, period: 'month', descriptionEn: 'Beta period - all features!', descriptionId: 'Periode beta - semua fitur!', videoLimit: 20, chatLimit: 50, featuresEn: ['50 Ai chat/day', '20 video analysis/day', 'Full knowledge base', 'All features unlocked'], featuresId: ['50 chat Ai/hari', '20 analisis video/hari', 'Knowledge base lengkap', 'Semua fitur aktif'], isPopular: false, isActive: true, sortOrder: 1 },
  { slug: 'basic', name: 'Basic', priceIdr: 10000, period: 'month', descriptionEn: 'For casual creators', descriptionId: 'Untuk kreator kasual', videoLimit: -1, chatLimit: -1, featuresEn: ['Unlimited Ai chat', 'Unlimited video analysis', 'Full knowledge base', 'Save history'], featuresId: ['Chat Ai unlimited', 'Analisis video unlimited', 'Knowledge base lengkap', 'Simpan riwayat'], isPopular: false, isActive: true, sortOrder: 2 },
