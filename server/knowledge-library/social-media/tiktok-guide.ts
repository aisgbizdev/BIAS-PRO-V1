// TikTok Complete Knowledge Base - Algorithm, Viral Formula, Growth Hacks
// Updated for 2025 - Awam-Friendly & Actionable

export const TikTokKnowledge = {
...
// Helper function untuk quick tips lookup
export function getTikTokTip(topic: string): string {
